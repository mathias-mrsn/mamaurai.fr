...
export const WelcomeAnimation = () => {
    ...
    <>
        <div className="fixed top-0 left-0 w-full h-full flex flex-row z-[9999] animate-[hide\_at\_end_5.5s_linear_forwards] cursor-none">
            ...
            <div className="w-1/2 h-full flex">
                <div className="relative lg:w-1/2 w-full h-full bg-gray-50 dark:bg-zinc-900 flex justify-start items-center text-left lg:border-r  border-gray-500 animate-[moving\_down_5.5s_ease-in-out_forwards]">
                ...
                <div className="relative w-0 lg:w-1/2 bg-gray-50 dark:bg-zinc-900 animate-[moving\_down_5.6s_ease-in-out_forwards] max-lg:hidden"/>
            </div>
        </div>
    </>
    );
